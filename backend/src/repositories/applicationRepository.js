...
class ApplicationRepository {
   ...
   */
  alreadyApplied(jobId, applicantId) {
   ...
   */
  findApplicantsByJobId(_jobId, _filters = {}, _pagination = {}) {
    const jobId = _jobId;
   ...
   * @param {Object} filters
   */
  findByApplicantId(applicantId, filters = {}) {
   ...
   * @param {string} status
   */
  updateStatus(_applicantId, _jobId, _status) {
